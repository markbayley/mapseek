...
export const topREEProducers = [
  ...
  { name: "Burma", coords: [96, 21], production: 31000 },
...
export const topPetroleumProducers = [
...
export const topCobaltProducers = [
...
export const topDiamondProducers = [
...
export const topAluminiumProducers = [
...
export const topIronOreProducers = [
...
export const topSilverProducers = [
...
// Top 10 copper producers (2024, in tons)
export const topCopperProducers = [
  { name: "Chile", coords: [-70.6693, -33.4489], production: 5600000 },
  { name: "Peru", coords: [-77.0428, -12.0464], production: 2500000 },
  { name: "DR Congo", coords: [22, -3], production: 2200000 },
  { name: "China", coords: [105, 35], production: 1700000 },
  { name: "United States", coords: [-110, 35], production: 1200000 },
  { name: "Australia", coords: [135, -25], production: 900000 },
  { name: "Russia", coords: [100, 60], production: 850000 },
  { name: "Zambia", coords: [28, -15], production: 800000 },
  { name: "Mexico", coords: [-102, 23], production: 720000 },
  { name: "Indonesia", coords: [120, -5], production: 700000 },
];

// Formatting functions
export function formatProduction(n: number): string {
  if (n >= 1000000) return (n / 1000000).toFixed(1).replace(/\.0$/, '') + 'M t';
  if (n >= 1000) return (n / 1000).toFixed(0) + 'k t';
  return n + ' t';
}
export function formatCoal(n: number): string {
  return n + ' Mt';
}
export function formatGas(n: number): string {
  return (n / 1000).toFixed(0) + ' B m³';
}
export function formatPetroleum(n: number): string {
  return (n / 1000000).toFixed(1).replace(/\.0$/, '') + ' M bbl/d';
}
export function formatCobalt(n: number): string {
  return n + ' t';
}
export function formatDiamond(n: number): string {
  return n + ' M ct';
}
export function formatGold(n: number): string {
  return n + ' t';
}
export function formatAluminium(n: number): string {
  return n + 'k t';
}
export function formatIronOre(n: number): string {
  return n + 'k t';
}
